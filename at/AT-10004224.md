---
title: "Verordnung des Bundesministers für Finanzen vom 13. Dezember 1976 über die Aufstellung von Durchschnittssätzen für die Ermittlung der abziehbaren Vorsteuerbeträge bei bestimmten Gruppen von Unternehmern"
identifier: "AT-10004224"
country: "at"
rank: "verordnung"
publication_date: "1977-01-01"
last_updated: "1977-01-01"
status: "repealed"
source: "https://www.ris.bka.gv.at/eli/bgbl/1976/692/P0/NOR11004260"
...
official_journal: "BGBl. Nr. 692/1976"
bgbl_number: "692/1976"
...
consolidated_url: "https://www.ris.bka.gv.at/GeltendeFassung.wxe?Abfrage=Bundesnormen&Gesetzesnummer=10004224"
gesetzesnummer: "10004224"
---
...
```
2. praktische Ärzte mit Hausapotheke ................     6,5
```
...
```
2. für folgende der Bundesinnung der Dachdecker
```
...
```
3. für folgende der Bundesinnung der
```
...
```
a) Hafner (Ofensetzer) Töpfer und
```
...
```
4. für folgende der Bundesinnung der Glaser
```
...
```
5. für folgende der Bundesinnung der Maler,
```
...
```
6. für folgende der Bundesinnung der Zimmer-
```
...
```
7. für folgende der Bundesinnung der Tischler
```
...
```
8. für folgende der Bundesinnung der Karosserie-
```
...
```
9. für folgende der Bundesinnung der Binder,
```
...
```
10. für folgende der Bundesinnung der Bürsten-
```
...
```
a) Schlosser (einschließlich Maschinen-
```
...
```
b) Landmaschinenerzeuger und Landmaschinen-
```
...
```
12. für folgende der Bundesinnung der Spengler
```
...
```
14. für folgende der Bundesinnung der Elektro-,
```
...
```
15. für folgende der Bundesinnung der Kunststoff-
```
...
```
16. für folgende der Bundesinnung der Metallgießer,
```
...
```
17. für folgende der Bundesinnung der Mechaniker
```
...
```
a) Kraftfahrzeugmechaniker und Kraftfahrzeug-
```
...
```
21. für folgende der Bundesinnung der Musik-
```
...
```
a) Kürschner und Kappenmacher, sowie Handschuh-
```
...
```
23. für folgende der Bundesinnung der Lederwaren-
```
...
```
30. für folgende der Bundesinnung der Sticker,
```
...
```
31. für folgende der Bundesinnung der Müller
```
...
```
32. für folgende der Bundesinnung der Bäcker
```
...
```
38. für folgende der Bundesinnung der graphischen
```
...
```
39. für folgende der Bundesinnung der Fotografen
```
...
40. für folgende der Bundesinnung der chemischen
...
```
41. für folgende der Bundesinnung der Friseure
```
...
```
43. für folgende der Bundesinnung der Chemisch-
```
...
```
b) Wäscher, Wäschebügler, Heißmangler, Wäsche-
```
...
```
45. für folgende der Bundesinnung der Optiker
```
...
```
47. für folgende dem Bundesgremium des Einzelhandels
```
...
```
50. für folgende dem Bundesgremium des Handels mit
```
...
```
52. für folgende dem Bundesgremium des Handels mit
```
...
53. für folgende dem Bundesgremium des Handels mit
...
```
54. für folgende dem Bundesgremium des Eisenhandels
```
...
```
55. für folgende dem Bundesgremium des Fahrzeug-
```
...
```
58. für folgende dem Bundesgremium des Handels mit
```
...
```
a) Einzelhandel mit Möbeln, Linoleum, Teppichen
```
...
```
60. für folgende dem Bundesgremium des Handels mit
```
...
```
61. für folgende dem Bundesgremium des Parfümerie-
```
...
```
62. für folgende dem Bundesgremium der Tabak-
```
...
```
63. für folgende dem Bundesgremium der Handels-
```
...
```
64. für folgende dem Bundesgremium des Markt-,
```
...
```
65. für folgende dem Allgemeinen Bundesgremium zu-
```
...
```
66. für folgende dem Fachverband der Vergnügungs-
```
...
```
67. für folgende dem Allgemeinen Fachverband des
```
...
```
68. für die dem Fachverband der Sägeindustrie zu-
```
...
1. Von den im § 6 angeführten Berufsgruppen mit Ausnahme jener der Z 41, 43 und 63:
