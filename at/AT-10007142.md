...
identifier: "AT-10007142"
country: "at"
rank: "verordnung"
publication_date: "1991-04-01"
last_updated: "1900-01-01"
status: "repealed"
source: "https://www.ris.bka.gv.at/eli/bgbl/1991/155/P0/NOR11007256"
department: "BKA (Bundeskanzleramt)"
short_title: "Festlegung von Warenkontingenten in der Einfuhr"
official_journal: "BGBl. Nr. 155/1991"
bgbl_number: "155/1991"
repeal_date: "1995-03-09"
amendment_bgbl: "172/1995"
amendment_relation: "aufgehoben durch"
amendment_note: "BGBl. Nr. 658/1991 BGBl. Nr. 172/1995 (NR: GP XIX RV 71 AB 112 S. 20. BR: AB 4974 S. 596.)"
keywords: "BGBl. Nr. 184/1984; Spinnstoffanteile"
consolidated_url: "https://www.ris.bka.gv.at/GeltendeFassung.wxe?Abfrage=Bundesnormen&Gesetzesnummer=10007142"
gesetzesnummer: "10007142"
---
...
```
Photoapparate, Filmkameras, Musikinstrumente
```

```
oder Waffen, Pistolenhalfter, ähnliche Behältnisse;
```
...
```
ex 30 - Waren dieser Unternummer ausgenommen:
```
...
```
Nylon- oder andere Polyamidfilamente enthaltend:
```
...
```
nicht texturierte Polyesterfilamente enthaltend:
```

```
ex 60 - Waren dieser Unternummer ausgenommen:
```
...
```
einem Quadratmetergewicht von 170 g oder weniger:
```
...
```
11  - - aus Polyesterstapelfasern, in Leinwandbindung.....   3
```
...
```
4-bindigem (einschließlich gleichseitigem) Köper..   3
```
...
```
21  - - aus Polyesterstapelfasern, in Leinwandbindung.....   4
```
...
```
4-bindigem (einschließlich gleichseitigem) Köper..   4
```
...
```
31  - - aus Polyesterstapelfasern, in Leinwandbindung.....   4
```
...
```
41  - - aus Polyesterstapelfasern, in Leinwandbindung.....   4
```
...
```
Pyjamas, Negliges, Bademäntel, Hausmäntel
```

```
und ähnliche Waren, gewirkt oder gestrickt, für
```

```
Frauen oder Mädchen...................................   5
```
...
```
zusätzlich angebrachten Sohlen, gewirkt
```
...
```
und ähnliche Waren, für Männer oder Knaben............   6
```
...
```
(rekonstituiertes Leder) und Oberteilen aus Leder:
```

```
ex  - Waren dieser Nummer mit Oberteilen aus Leder,
```

```
die außer Zubehör oder Verstärkungen aus
```

```
Spinnstofferzeugnissen oder Kunststoffen keine
```

```
Spinnstoff- oder Kunststoffanteile enthalten........   8
```

```
9506  --  Geräte und Ausrüstungen für Gymnastik, Athletik,
```
...
```
Kapitels genannt oder inbegriffen; Schwimmbecken
```
...
```
6109  --  T-Shirts und Unterleibchen, gewirkt oder gestrickt:...   5
```
