...
(2) Im Fall eines Trusts bedeutet dieser Ausdruck den oder die Treugeber, den oder die Treuhänder, (gegebenenfalls) den Protektor oder die Protektoren, den oder die Begünstigten oder die Begünstigtenklasse(n) sowie jede/alle sonstige(n) natürliche(n) Person(en), die den Trust tatsächlich beherrscht bzw. beherrschen, unabhängig vom Wert der Zuwendungen von dem Trust.

(3) Im Fall eines Rechtsgebildes, das kein Trust ist, bedeutet dieser Ausdruck Personen in gleichwertigen oder ähnlichen Positionen wie den in Abs. 2 erwähnten, unabhängig vom Wert der Zuwendungen von dem Rechtsgebilde.
