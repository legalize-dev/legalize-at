...
identifier: "AT-20006124"
country: "at"
rank: "verordnung"
publication_date: "2008-08-01"
last_updated: "2008-08-01"
status: "repealed"
source: "https://www.ris.bka.gv.at/eli/bgbl/ii/2008/453/P0/NOR30006821"
department: "BKA (Bundeskanzleramt)"
short_title: "Durchführung von gemeinschaftlichen Marktordnungsmaßnahmen im Weinbereich"
official_journal: "BGBl. II Nr. 453/2008"
bgbl_number: "453/2008"
repeal_date: "2010-04-13"
amendment_bgbl: "112/2010"
amendment_relation: "aufgehoben durch"
amendment_note: "BGBl. II Nr. 165/2011 BGBl. II Nr. 63/2015"
keywords: "Aufzeichnungspflicht; BGBl. I Nr. 55/2007; BGBl. Nr. 103/1951; Duldungspflicht; Landwein; Standmiete; Verkaufsräumlichkeit; Vermarktungschance; Verschubarbeit; Werbeagentur"
consolidated_url: "https://www.ris.bka.gv.at/GeltendeFassung.wxe?Abfrage=Bundesnormen&Gesetzesnummer=20006124"
gesetzesnummer: "20006124"
---
...
materiell derogiert durch BGBl. II Nr. 112/2010
...
1. der Verordnung (EG) Nr. 479/2008 über die gemeinsame Marktorganisation für Wein, ABl. Nr. L 148 vom 6. Juni 2008,
...
```
| A.  | Weingartenumstellung                  |     5.200,- €   |
```

```
|     | Weingartenumstellung in der Hanglage  |     8.793,- €   |
```

```
|     | Weingartenumstellung in der Steillage |    11.608,- €   |
```
...
```
| C.  | Böschungsterrassen                    |    8,00 €/lfm   |
```

```
|     | Neuerrichtung oder Rekultivierung von |   gem. Pkt. A.) |
```

```
|     | Terrassen (Beihilfe wird pro          |                 |
```
...
```
|     | Terrassen (Beihilfe wird pro m² Mauer |                 |
```
...
```
| E.  | Bewässerung                           |    50% der      |
```

```
|     | Die nachweisbaren Kosten sind der     |  Errichtungs-   |
```

```
|     | Rechnungsbetrag exkl. Umsatzsteuer    |    kosten       |
```

```
|     | abzüglich sämtlicher Nachlässe        | gem. § 14 Abs. 3|
```
...
```
|     | (Die Beihilfe/ha erhöht sich um den   |                 |
```

```
|     | nebenstehenden Betrag)                |                 |
```
...
```
| G.  | Schutz vor Wildverbiss                |    50% der      |
```
...
```
|     | abzüglich sämtlicher Nachlässe        | gem. § 14 Abs. 4|
```
...
```
| H.  | Schutz vor Vogelfraß und Hagel        |    50% der      |
```
