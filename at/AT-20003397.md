---
title: "Verordnung des Bundesministers für Wirtschaft und Arbeit über die Berufsausbildung im Lehrberuf Werkzeugmechanik (Werkzeugmechanik-Ausbildungsordnung)"
identifier: "AT-20003397"
country: "at"
rank: "verordnung"
publication_date: "2004-06-01"
last_updated: "1900-01-01"
status: "repealed"
source: "https://www.ris.bka.gv.at/eli/bgbl/ii/2004/242/P0/NOR30003702"
department: "BKA (Bundeskanzleramt)"
short_title: "Werkzeugmechanik-Ausbildungsordnung"
official_journal: "BGBl. II Nr. 242/2004"
bgbl_number: "242/2004"
...
keywords: "<br/>Branchenstellung; <br/>Pneumatikberechnung; <br/>Qualitätssicherungssystem; Bauvorschrift; Drehmaschine; Drehzahlberechnung; Fertigungssystem; Festigkeitsberechnung; Flächenberechnung; Klebeverfahren; Leistungsberechnung; Längenberechnung; Maschinenelement; Messmittel; Projektmanagementsystem; Prüfgerät; Schlussbestimmung; Stanzbautechnik; Stanztechnik; Stromlaufplan; Umweltschutzmaßnahme; Verschleißschutz; Volumenberechnung; Werkzeichnung"
consolidated_url: "https://www.ris.bka.gv.at/GeltendeFassung.wxe?Abfrage=Bundesnormen&Gesetzesnummer=20003397"
gesetzesnummer: "20003397"
---
...
```
1.     stellung und   Kundenkreises des Lehrbetriebes
```
...
```
3.        Personalcomputer; Anwendung der betriebsspezifischen
```
...
```
7.     Schleifen von Hand und unter      unter Verwendung von
```
...
```
9.         Stiftverbindungen und        und Schutzgasschweißen
```
...
```
10.         Lesen und Anfertigen             Lesen einfacher
```
...
```
11.          -              -           rechnergestützten Zeichnens
```
...
```
13.           Zusammenstellungszeichnungen und Montageplänen
```
...
```
15.         Anlassen, Vergüten                (Randschicht-,
```
...
```
16.                   Verschleiß- und Korrosionsschutz
```
...
```
17.        Bolzen, Keile, Federn,            Führungssäulen,
```
...
```
18.          -       hydraulischen, elektrischen und elektronischen
```
...
```
21.      trennenden und umformenden        der Werkzeuge der
```
...
```
22.          Vorgänge bei dem              der Werkzeuge der
```
...
```
24.          -           Werkzeugen erzeugten Werkstoffe, wie
```
...
```
25.          Qualitätsmanagement           Qualitätsmanagement
```
...
```
26.          -              Kenntnis des Projektmanagements
```
...
```
27.        Kenntnis und Anwendung englischer Fachausdrücke
```
...
```
28.                 Sicherheitsvorschriften, wie
```
...
```
29.         Anwendung von Präsentationshilfen (wie Werkstücke,
```
...
```
30.               Rhetorik, fachgerechte Ausdrucksweise
```
...
```
31.          Zusammenarbeiten im Team, Umgehen mit Konflikten
```
...
```
32.              facheinschlägigen Unterlagen, Internet)
```
...
```
33.      betrieblichen Maßnahmen zum sinnvollen Energieeinsatz im
```
...
```
34.        Vorschriften zum Schutz des Lebens und der Gesundheit
```
...
```
35.                  Verpflichtungen (§§ 9 und 10 des
```
...
2. Maschinen-, Verbindungselemente und Verbindungstechnik,

3. Maschinensicherheit, Unfallverhütung, Schutzmaßnahmen und Sicherheitsvorschriften.
...
(4) Die Klausurprüfung und die mündliche Prüfung sind unter Einbeziehung eines Experten aus dem höheren technischen Schulwesen durchzuführen.
...
6. Programmiertechnik für Werkzeugmaschinen,
...
3. facheinschlägige Berechnungen (wie Festigkeits-, Drehzahl-, Leistungs-, Pneumatik-, Hydraulikberechnungen etc.),

4. Stanz-, Drucktechnik und Formenbau,

5. Messtechnik und Qualitätssicherung,

6. Berechnungen zu rechnergestützten Fertigungsprogrammen.
...
(2) Die Ausbildungsordnung für den Lehrberuf Werkzeugmechaniker, BGBl. II Nr. 81/1997, tritt unbeschadet des Abs. 3 mit Ablauf des 31. Mai 2004 außer Kraft.

(3) Lehrlinge, die am 31. Mai 2004 im Lehrberuf Werkzeugmechaniker ausgebildet werden, können gemäß der in Abs. 2 angeführten Ausbildungsordnung bis zum Ende der vereinbarten Lehrzeit ausgebildet werden und können bis ein Jahr nach Ablauf der vereinbarten Lehrzeit zur Lehrabschlussprüfung gemäß den in dieser Ausbildungsordnung festgelegten Prüfungsbestimmungen antreten.

(4) Die Lehrzeiten, die im Lehrberuf Werkzeugmechaniker entsprechend der im Abs. 2 angeführten Ausbildungsordnung zurückgelegt wurden, sind auf die Lehrzeit im Lehrberuf Werkzeugmechanik voll anzurechnen.
