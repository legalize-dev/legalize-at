...
§ 2a. Belastungsschwerpunkte im Sinne dieser Verordnung sind Bereiche innerhalb von Untersuchungsgebieten, in denen die höchsten Konzentrationen auftreten, denen die Bevölkerung wahrscheinlich direkt oder indirekt über einen Zeitraum ausgesetzt sein wird, der im Vergleich zur Mittelungszeit der betreffenden Grenzwerte signifikant ist.
...
| Untersuchungsgebiet | SO2 | NO2 | PM10 | PM2,5 (**) | Benzo(a)pyren in PM10 | CO |
| --- | --- | --- | --- | --- | --- | --- |
...
(2) In jeder Stadt mit mehr als 100 000 Einwohnern ist mindestens an einer PM10- und PM2,5Messstelle im zentralen Siedlungsgebiet und mindestens an einer PM10-Messtelle an einem verkehrsnahen Belastungsschwerpunkt die in Anlage 1 angeführte Referenzmethode oder ein äquivalentes gravimetrisches Verfahren anzuwenden.
...
§ 36. (1) Zur Erfüllung der Berichtspflichten gemäß den folgenden Richtlinien und Entscheidungen bedient sich die Bundesministerin für Klimaschutz, Umwelt, Energie, Mobilität, Innovation und Technologie des Umweltbundesamtes:
...
i) Daten zu den Bereichen innerhalb von Untersuchungsgebieten gewonnen werden, in denen die höchsten Konzentrationen auftreten, denen die Bevölkerung wahrscheinlich direkt oder indirekt über einen im Verhältnis zur Mittelungszeit der betreffenden Grenzwerte signifikanten Zeitraum ausgesetzt sein wird;

ii) Daten zu Konzentrationen in anderen Bereichen innerhalb von Untersuchungsgebieten gewonnen werden, die für die Exposition der Bevölkerung im Allgemeinen repräsentativ sind.
...
| Untersuchungsgebiet | Standorttyp | Messstelle | SO2 | PM10 | NO2, NOx | CO | Benzol | PM2,5 | B(a)P | Pb | As | Cd | Ni |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| B | ländlicher Hintergrund | Illmitz | x | x | x | x |  | x | x | x | x | x | x |
| K | industrienah | Arnoldstein |  |  |  |  |  |  |  | x | x | x |  |
| K | Großstadt, städtischer Hintergrund | Klagenfurt Sterneckstraße | x | x | x |  |  | x |  |  |  |  |  |
...
I. Datenqualitätsziele für die Luftqualitätsbeurteilung für die Schadstoffe SO2, NO2, NOx, CO, Benzol, PM10, PM2,5 und Pb
