...
```
10.4  Kenntnis des Buchmarktes und Musikalienhandels hinsichtlich
```

```
der Verlage, Fachgebiete, Titel, Autoren und neuen Trends
```

```
unter Berücksichtigung des Schwerpunktes des
```
