---
title: "Verordnung des Bundesministers für Wirtschaft und Arbeit, mit der Ausbildungsvorschriften für den Lehrberuf Versicherungskaufmann/Versicherungskauffrau erlassen werden"
identifier: "AT-20003158"
country: "at"
rank: "verordnung"
publication_date: "2004-01-01"
last_updated: "2004-01-01"
status: "repealed"
source: "https://www.ris.bka.gv.at/eli/bgbl/ii/2004/15/P0/NOR30003447"
department: "BKA (Bundeskanzleramt)"
short_title: "Ausbildungsvorschriften für den Lehrberuf Versicherungskaufmann/Versicherungskauffrau"
official_journal: "BGBl. II Nr. 15/2004"
bgbl_number: "15/2004"
repeal_date: "2020-04-30"
amendment_bgbl: "72/2020"
amendment_relation: "aufgehoben durch"
amendment_note: "BGBl. II Nr. 72/2020"
keywords: "<br/>Beschaffungsmöglichkeit; <br/>Versicherungsmöglichkeit; <br/>Öffentlichkeitsarbeit; Abfallstoff; Antragsbearbeitung; Arbeitsmittel; Betriebsorganisation; Geldinstitut; Informationssystem; Innenorganisation; Organisationsmittel; Postausgang; Posteingang"
consolidated_url: "https://www.ris.bka.gv.at/GeltendeFassung.wxe?Abfrage=Bundesnormen&Gesetzesnummer=20003158"
gesetzesnummer: "20003158"
---
...
```
5.3           -            Kenntnis und Mitwirken im Mahnwesen,
```
...
```
6.1     Kenntnis der rechtlichen Grundlagen
```

```
der Versicherungswirtschaft (wie              -
```
...
```
6.2     Kenntnis des Versicherungsvertragsrechts (VersVG), des
```
...
```
6.3     Kenntnis des Aufbaus von Tarifen und der Tarifgestaltung
```
...
```
6.4        Überblick über die einzelnen Versicherungssparten
```
...
```
6.5        Antragsannahme, Bearbeitung und Polizzenerstellung
```
...
```
6.7        Kenntnis über das Zusammenwirken von Innen- und
```
...
```
Versicherungsbereichen sowie mit anderen Unternehmen der
```
...
```
6.8      Kenntnis und Anwendung einschlägiger fremdsprachiger
```
...
```
6.9     Kenntnis der versicherungsrelevanten Steuern und Abgaben
```
...
```
6.10          -            Kenntnis der verschiedenen
```
...
```
6.11          -            Kenntnis und Mitwirken beim Verkauf
```
...
```
6.12          -            Beratung in Versicherungsangelegenheiten
```
...
```
6.13          -             Ausarbeiten und Berechnen von Offerten
```
...
```
6.16          -               Kenntnis über das Leistungsrecht
```
...
```
6.17          -              Schadenaufnahme und Schadenprüfung
```
...
§ 5. (1) Die Ausbildungsvorschriften für den Lehrberuf Versicherungskaufmann, BGBl. II Nr. 344/1990 (Anm.: richtig: BGBl. Nr. 344/1990), treten mit Ablauf des 31. Dezember 2003 außer Kraft.
