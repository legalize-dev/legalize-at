---
title: "Verordnung des Bundesministers für wirtschaftliche Angelegenheiten über die Berufsausbildung im Lehrberuf Werkzeugmechaniker (Werkzeugmechaniker-Ausbildungsordnung)"
identifier: "AT-10007913"
country: "at"
rank: "verordnung"
publication_date: "1997-07-01"
last_updated: "1900-01-01"
status: "repealed"
source: "https://www.ris.bka.gv.at/eli/bgbl/ii/1997/81/P0/NOR11008056"
department: "BKA (Bundeskanzleramt)"
short_title: "Werkzeugmechaniker-Ausbildungsordnung"
official_journal: "BGBl. II Nr. 81/1997"
bgbl_number: "81/1997"
repeal_date: "2004-05-31"
amendment_bgbl: "242/2004"
amendment_relation: "aufgehoben durch"
amendment_note: "idF: BGBl. II Nr. 242/2004"
keywords: "Elektromaschinenbauer; Flächenberechnung; Längenberechnung; Personenschaden; Problemlösungsthema; Schlußbestimmung; Schneidbereich; Sicherheitsnorm; Spritzgießbereich; Stanzbereich; Stanztechnik; Stromlaufplan; Stromlaufskizze; Verwendungsmöglichkeit; Volumsberechnung; Werkstoff; Werkzeugfreigabe"
consolidated_url: "https://www.ris.bka.gv.at/GeltendeFassung.wxe?Abfrage=Bundesnormen&Gesetzesnummer=10007913"
gesetzesnummer: "10007913"
---
...
4. Erstellen von NC-Programmen für die Herstellung von komplexen Werkstücken inklusive Bearbeitung auf CNC gesteuerten Werkzeugherstellungsmaschinen, wie NC-Fräsen, NC-Drehen, NC Erodieren, NC-K-Schleifen, NC-Schleifen,
...
15. Leisten eines Beitrags zu einer bewußt geprägten und gelebten Unternehmenskultur (Arbeitsatmosphäre).
...
```
3.   Einfaches Messen               Messen und Prüfen
```
...
```
12.           -              -       Kenntnis des   Funkenerosives
```
...
```
32.   Grundkennt-     Kenntnis und Anwendung der Maschinenelemente,
```
...
```
33.           -     Herstellen von einschlägigen Werkstücken unter
```
...
```
35.           -     Grundkennt-               Kenntnis und Anwendung
```
...
```
37.           -     Grundkenntnisse  Kenntnis und   Kenntnis und
```
...
```
38.           -     Grundkenntnisse  Kenntnis und   Kenntnis und
```
...
```
43.           -              -     Lesen von einfachen Stromlauf- und
```
...
c) richtiges Erstellen einer pneumatischen Simulation.
...
4. Personen, die die Lehrabschlußprüfung im Lehrberuf „Werkzeugmechaniker'' abgelegt haben,
...
6. Personen, die die Lehrabschlußprüfung in einem nicht unter Z 5 fallenden mit dem Lehrberuf „Werkzeugmechaniker'' verwandten Lehrberuf abgelegt haben und zumindest ein Jahr einschlägig tätig waren,
