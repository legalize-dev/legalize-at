---
title: "Verordnung des Bundesministers für Wirtschaft und Arbeit über die Berufsausbildung im Lehrberuf Fassbinder/Fassbinderin (Fassbinder/Fassbinderin-Ausbildungsordnung)"
identifier: "AT-20004300"
country: "at"
rank: "verordnung"
publication_date: "2005-07-01"
last_updated: "1900-01-01"
status: "in_force"
source: "https://www.ris.bka.gv.at/eli/bgbl/ii/2005/275/P0/NOR30004686"
department: "BKA (Bundeskanzleramt)"
short_title: "Fassbinder/Fassbinderin-Ausbildungsordnung"
official_journal: "BGBl. II Nr. 275/2005"
bgbl_number: "275/2005"
keywords: "Bearbeitungsmöglichkeit; Betriebsform; Flächenberechnung; Metallbearbeitung; Qualitätskontrolle; Sicherheitsdatenblatt; Volumsberechnung; Werkstoff"
consolidated_url: "https://www.ris.bka.gv.at/GeltendeFassung.wxe?Abfrage=Bundesnormen&Gesetzesnummer=20004300"
gesetzesnummer: "20004300"
---
...
6. Herstellen von Lehren (Modeln),

7. Herstellen, Einrichten und Aufstellen von Gebinden,

8. Reinigen, Warten und Reparieren von Gebinden,

9. Durchführen der Funktionsprüfung und Qualitätskontrolle,

10. Kundenorientiertes Verhalten und Kundenberatung insbesondere über Gebindeformen in der Kellereiwirtschaft.
...
```
9.       Grundkenntnisse über die Lagerung und die
```
...
```
10.       Anfertigen von Skizzen und einfachen Werkzeichnungen
```
...
```
12.              Kenntnis über die Kellereiwirtschaft
```
...
```
14.       Herstellen von Lehren (Modeln)
```
...
```
15.      Messen, Anreißen, Aufreißen, Raspeln, Feilen, Bohren,
```
...
```
16.                         Herstellen von lösbaren und unlösbaren
```
...
```
23.                            Zurichten von Dauben und Böden
```
...
```
24.                           Behandeln der inneren und äußeren
```
...
```
25.                           Gebinde einrichten und aufstellen
```
...
```
30.     Kenntnis der         Durchführen von Funktionsprüfungen
```
...
```
31.       Kenntnisse der Qualitätssicherung einschließlich der
```
...
```
34.     Kenntnis über die Erstversorgung bei betriebsspezifischen
```
...
```
35.         Kenntnis der einschlägigen Sicherheitsvorschriften
```
...
1. Zurichten von Dauben und Böden,

2. Messen, Aufreißen, Anreißen,

3. Sägen, Hobeln, Fügen, Aufsetzen,

4. Schneiden, Gargeln,

5. Dübeln, Leimen,

6. Fräsen, Raspeln, Feilen,

7. Bohren, Nieten, Hämmern, Abbinden,
...
2. fachgerechtes Aufsetzen und Ausfertigen eines Gebindes,
