...
identifier: "AT-10007265"
country: "at"
rank: "verordnung"
publication_date: "1992-09-01"
last_updated: "1900-01-01"
status: "repealed"
source: "https://www.ris.bka.gv.at/eli/bgbl/1992/540/P0/NOR11007380"
department: "BKA (Bundeskanzleramt)"
short_title: "Bewilligungspflicht der Ausfuhr; Überlassung von Waren im Zollausland"
official_journal: "BGBl. Nr. 540/1992"
bgbl_number: "540/1992"
repeal_date: "1992-12-31"
amendment_bgbl: "848/1992"
amendment_relation: "aufgehoben durch"
amendment_note: "idF: BGBl. Nr. 848/1992"
keywords: "BGBl. Nr. 184/1984; BGBl. Nr. 443/1986; Sportgewehr"
consolidated_url: "https://www.ris.bka.gv.at/GeltendeFassung.wxe?Abfrage=Bundesnormen&Gesetzesnummer=10007265"
gesetzesnummer: "10007265"
---
...
3. des Abschnittes III der Ausfuhrliste auf Grund von Rechtsgeschäften oder Handlungen zur Verbringung in ein anderes Land als das bei der Ausfuhr aus Österreich angegebene Bestimmungsland;
...
1. von im Abschnitt III der Ausfuhrliste genannten Waren im Zwischenauslandsverkehr (§ 127 des Zollgesetzes 1988, BGBl. Nr. 661/1987, in der jeweils geltenden Fassung), es sei denn, daß die betreffenden Waren im Zollausland verbleiben,
...
```
a) mit einer organischen Matrix und
```
...
b) die Fertigung, Handhabung und Abnahmeprüfung sowie das Mischen, Härten, Gießen,
...
a) zwei oder mehr Rührern zum Mischen und/oder Kneten und

b) Öffnungsmöglichkeiten der Mischkammer
...
a) Strukturelle Materialien und Beschichtungen, speziell
...
a) Metall-Legierungen wie folgt:

1. Auf Nickel oder Titan

a) Nickelaluminide, die

b) Titanaluminide, die

2. Metall-Legierungen wie folgt,

a) Nickellegierungen mit:

1. einer Spannung-Bruch-Lebensdauer von

2. einer Ermüdung bei

b) Niobiumlegierungen mit:

1. einer Spannung-Bruch-Lebensdauer von

2. einer Ermüdung bei

c) Titanlegierungen mit:

1. einer Spannung-Bruch-Lebensdauer von

2. einer Ermüdung bei

d) Aluminiumlegierungen mit

1. 240 MPa oder mehr bei

2. 415 MPa oder mehr bei

e) Magnesiumlegierungen mit

-----------------------------------

ANMERKUNGEN:

1. Die Metall-Legierungen in Nummer 1C02.a sind solche, bei

2. Die Spannung-Bruch-Lebensdauer

3. Die Ermüdung bei niedriger

-----------------------------------

b) Metall-Legierungspulver oder

1. Hergestellt aus einer der

a) Nickellegierungen (Ni-Al-X, Ni-X-Al), qualifiziert für

b) Niobiumlegierungen (Nb-Al-X

c) Titanlegierungen (Ti-Al-X oder Ti-X-Al);

d) Aluminiumlegierungen

e) Magnesiumlegierungen
...
e) Schmelzspinnen und Feinzerkleinerung;

f) Schmelzextraktion und Feinzerkleinerung; oder

g) Mechanisches legieren;

c) Legierte Materialien in Form von nicht-feinzerkleinerten Flocken,
...
b) einer Elastizitätsgrenze von
...
4. Aromatische Polyetherimide mit
...
2. einem Schmelz-, Zersetzungs- oder Sublimationspunkt vom

a) diskontinuierliche,

b) Molybdän und Molybdän-Legierungsfasern;
...
a) Polyetherimide, erfaßt in Nummer 1C08.a; oder

b) Materialien, erfaßt in Nummer 1C08.b, c, d, e oder
...
```
a) Technologie zur Entwicklung oder   (einschließlich
```
...
```
b) Technologie zur Entwicklung oder   in Autoklaven oder Hydroklaven,
```
...
```
c) Technologie zur Konstruktion       werden.
```
...
```
a) Maximaler Arbeitsdruck von      a) mit einer Temperaturregelung
```
...
```
b) mit:                            b) Konstruiert, um eine
```

```
1. einem maximalen Arbeitsdruck    kontrollierte Hitzeumgebung von
```
...
```
2. einer geregelten                erreichen und
```
...
```
3. einer Vorrichtung zur           Inches) oder mehr.
```
...
```
2. a) mit eingebauten Hochvakuum-
```
...
```
c) Speicherprogrammierbare EB-PVD-
```
...
```
5. MCrAlX bezieht sich auf eine
```
...
```
a) CVD-Verfahren (Chemical Vapour
```
...
```
d) Packungszementierung ist ein
```
...
```
2. einem Aktivator (normalerweise
```
...
```
f) Schlammsedimentation ist ein
```
...
```
g) Sputtersedimentation ist ein
```
...
```
2. Langsame Ionenstrahlen (weniger
```
...
```
1. einer Auflösung von 8 Bit a) konstruiert im Hinblick auf die
```
...
```
3. Supraleitende Elektromagnete
```
...
```
4. Schaltungen oder Systeme zur
```
...
```
2. einer Genauigkeit besser als
```
...
```
1. Rechner, verwandte Geräte oder  ANMERKUNG:
```
...
b) Obergrenze der Strahlungsdosis 5 x 10 hoch
...
2. Der Erfassungsstatus von in Nummer 4A03 beschriebenen

a) die Digitalrechner oder die

b) die Digitalrechner oder die

1. Der Erfassungsstatus von in Nummer 4A03.g beschriebenen

2. Die Erfassung von

c) die Technologie für die Digitalrechner und verwandten
...
e) die Technologie für die Digitalrechner oder verwandten
...
1. entwickelt für den Zusammenschluß von 16 oder

2. ausgestattet mit einer

e) Plattenlaufwerke und Halbleiterspeicher wie folgt:
...
j) Geräte für Analog/Digital- oder Digital/Analog-Umwandlungen, die
...
a) Software mit mathematischen und
...
e) Software mit Eigenschaften oder
...
a) Technologie für die Entwicklung

b) Technologie für die Entwicklung
...
b) speziell geschützt gegen Gamma-,
...
b) konstruiert für eine Verwendung
...
b) speicherprogrammierbare digitale Crossconnect-Einrichtungen mit

c) Einrichtungen, die folgendes

1. Modems, die die Bandbreite

2. Kommunikationskanal-Kontroller
...
e) Funkeinrichtungen, mit Eingangs- und Ausgangsfrequenzen höher
...
1. mit Quadratur-Amplituden-Modulation (QAM) über Level 4;
...
1. a) automatische Prognose und Auswahl von Frequenzen und

b) mit eingebautem Linear-Leistungsverstärker der Mehrfachsignale simultan bei

2. mit eingebauten

h) Funkeinrichtungen, für die Austrahlung (Anm.: richtig: Ausstrahlung)

1. anwenderprogrammierbare

2. einer gesamten übertragenen

i) digital gesteuerte Funkempfänger

1. automatisch einen Teil des elektromagnetischen Spektrums

2. die empfangenen Signale oder

3. eine Frequenzumschaltzeit von

j) Einrichtungen, die digitale

1. Sprachcodierung bei weniger

2. mit einem Schaltungsaufbau,

k) Unterwasser-Kommunikationseinrichtungen mit

1. einer akustischen

2. eine elektromagnetische

3. Elektronenstrahl-Lenkverfahren
...
a) Zeichengabe über einen zentralen
...
b) mit ISDN (Integrated Services Digital Network)-Funktionen und
...
b) Nachrichtenverkehr auf einem D-Kanal des ISDN, ohne Bezug zu
...
1. eine Datenübertragungsgeschwindigkeit von
...
k) speicherprogrammierbare digitale

a) empfängt Daten von den Knoten,

b) verarbeitet diese Daten, um eine Verkehrssteuerung ohne
...
b) Analysatoren, Prüfeinrichtungen
...
c) Software, so konstruiert oder so

d) Software mit der Fähigkeit, den Quellencode von Software, die in
...
c) Technologie zur Bearbeitung und Aufbringung von Beschichtungen

d) Technologie zur Entwicklung oder

e) Technologie zur Entwicklung oder

f) Technologie zur Entwicklung oder

g) Technologie zur Entwicklung oder

h) Technologie zur Entwicklung oder
...
a) konstruiert oder abgeändert zur Verwendung von Verschlüsselungen

b) konstruiert oder abgeändert zur Ausführung von

c) konstruiert oder abgeändert zur Verwendung von Verschlüsselungen
...
e) konstruiert oder abgeändert zur Verwendung von

f) konstruiert oder abgeändert für
...
a) Software, die die Eigenschaften

b) Software zur Abnahme von in Nummer 5D13.a erfaßter Software;
...
1. Positionen des Abschnittes

a) Smart Cards für Personen mit Verschlüsselungen, zum Gebrauch in Einrichtungen und Systemen, die von Nummer

b) Einrichtungen, die feste
...
2. Positionen der Informationssicherheit in dieser Gruppe erfassen nicht:

a) Software, erforderlich zur Verwendung von Einrichtungen,

b) Software, mit einem Verfahren
...
```
a) die Durchführung von Messungen
```
...
```
b) eine Datengenauigkeit besser
```
...
```
2. nicht-raumfahrtqualifizierte
```
...
```
3. mechanische oder elektronische
```
...
```
4. elektronische Bildkameras mit
```
...
```
b) bilddarstellende Kameras wie
```
...
```
2. Stoßerregte Laser umfassen auch
```
...
```
b) einer Ausgangsenergie von mehr
```
...
```
a) einer Spitzenleistung von mehr
```
...
```
c) einer Impulsenergie von mehr
```
...
```
g) optische Geräte wie folgt:
```

```
1. dynamische Wellenfront-
```
...
```
b) Schwerkraftmesser für mobile       Einschwingzeit für
```
...
```
b) Einkristalle aus Cadmiumtellurid
```
...
```
2. Durchmesser größer als 80 mm bei
```
...
```
1. Kalium-Titanyl-Arsenat (KTiAs,
```
...
```
2. einer Ansprechzeit von weniger
```
...
```
a) einer Drift-Stabilität, gemessen
```
